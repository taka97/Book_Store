jQuery(function ($) {
  ...
  $(document).on('focusout', '.quantity_input', function () {
    var a = $(this).val()
    isNaN(parseFloat(a)) && !isFinite(a) || parseInt(a) == 0 || a == '' ? $(this).val(1) : parseInt(a) < 0 ? $(this).val(parseInt(a) - 2 * parseInt(a)) : $(this).val(parseInt(a))
    ...
    e(document.body).on('click', '.quick_view_btn', function (i) {
      ...
      e.getJSON(e(this).attr('href') + '.js', function (i) {
        ...
        e('#quick_view__name').html('<a href="' + i.url + '">' + a + '</a>'), e('#quick_view__type span').html(i.type), e('#quick_view__vendor span').html(i.vendor), e.each(i.variants, function (i, a) {
          ...
          var i = e(this).val()
          e(this).val(isNaN(parseFloat(i)) && !isFinite(i) || parseInt(i) == 0 || i == '' ? 1 : parseInt(i) < 0 ? parseInt(i) - 2 * parseInt(i) : parseInt(i))
          ...
          a(i.images, function () {
            ...
            var a = (new Swiper('#img_gallery', {
              ...
              if (i && i.available ? (jQuery('#quick_view__add').removeAttr('disabled').removeClass('disabled'), i.price < i.compare_at_price ? jQuery('#quick_view__price').html('<span class="money">' + Shopify.formatMoney(i.price, '') + '</span><span class="money compare-at-price money_sale">' + Shopify.formatMoney(i.compare_at_price, '') + '</span><span class="money_sale_percent">– ' + parseInt(100 - 100 * i.price / i.compare_at_price) + '%</span>') : jQuery('#quick_view__price').html('<span class="money">' + Shopify.formatMoney(i.price, '') + '</span>'), i.inventory_management != null ? jQuery('#quick_view__availability span').removeClass('notify_danger').addClass('notify_success').html('Available') : jQuery('#quick_view__availability span').removeClass('notify_danger').addClass('notify_success').html('Available')) : (jQuery('#quick_view__add').addClass('disabled').attr('disabled', 'disabled'), jQuery('#quick_view__availability span').removeClass('notify_success').addClass('notify_danger').html('Unavailable'), jQuery('#quick_view__price').html('<span class="money">' + Shopify.formatMoney(i.price, '') + '</span>')), i && i.featured_image) {
                var t = e('#img_big img'),
                  n = i.featured_image,
                  s = t[0]
            ...
            new Shopify.OptionSelectors('product-select', {
              ...
              e(this).val() == 'Default Title' && e('#quick_view__variants').hide()
  ...
  jQuery(document).ready(function (t) {
    ...
    t(e.FORM_UPDATE_CART_BUTTON).click(function (a) {
      ...
      t(e.TOTAL_PRICE).html(r), t(e.EMPTY_CART_MESSAGE).length > 0 && i.item_count == 0 && (t(e.FORM_UPDATE_CART).hide(), t(e.EMPTY_CART_MESSAGE).show()), n = n || !1, n && i.item_count > 0 && (t.each(i.items, function (i, n) {
  ...
  typeof Shopify === 'undefined' && (Shopify = {}), Shopify.money_format = '$ ', Shopify.onError = function (XMLHttpRequest, textStatus) {
    ...
    var r = {
      ...
      dataType: 'json',
      success: function (t) {
        typeof e === 'function' ? e(t) : Shopify.onItemAdded(t)
      },
      error: function (t, a) {
        Shopify.onError(t, a)
      }
    ...
    var r = {
      ...
      dataType: 'json',
      success: function (r) {
        typeof o === 'function' ? o(r, t) : Shopify.onItemAdded(r, t)
    ...
    jQuery.getJSON('/cart.js', function (a) {
      typeof t === 'function' ? t(a) : Shopify.onCartUpdate(a)
    })
  }, Shopify.getProduct = function (t, a) {
    jQuery.getJSON('/products/' + t + '.js', function (t) {
      typeof a === 'function' ? a(t) : Shopify.onProduct(t)
    })
    ...
    var r = {
      ...
      dataType: 'json',
      success: function (t) {
        typeof e === 'function' ? e(t) : Shopify.onCartUpdate(t)
      },
      error: function (t, a) {
        Shopify.onError(t, a)
      }
    ...
    var e = {
      ...
      dataType: 'json',
      success: function (t) {
        typeof a === 'function' ? a(t) : Shopify.onCartUpdate(t)
      },
      error: function (t, a) {
        Shopify.onError(t, a)
      }
    ...
    var e = {
      ...
      dataType: 'json',
      success: function (e) {
        typeof a === 'function' ? a(e, t) : Shopify.onCartUpdate(e, t)
      },
      error: function (t, a) {
        Shopify.onError(t, a)
      }
    ...
    }) : typeof t === 'object' && t !== null && jQuery.each(t, function (t, a) {
